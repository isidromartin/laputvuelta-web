    ...
    <main className="relative pt-28 pb-16 md:pt-32 md:pb-24">
      ...
      <Container>
        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-12">
          {/* Player */}
          <section className="lg:col-span-8 group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur transition hover:border-[var(--primary)]/30 hover:bg-white/[0.06]">
          ...
          {/* Chat */}
          <aside className="lg:col-span-4 group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur transition hover:border-[var(--primary)]/30 hover:bg-white/[0.06]">
            <span className="pointer-events-none absolute -inset-10 -z-10 rounded-3xl bg-[var(--primary)]/0 blur-3xl transition group-hover:bg-[var(--primary)]/14" />
            <span className="pointer-events-none absolute inset-0 rounded-3xl ring-1 ring-white/5" />
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <Link
            href="/tickets"
            className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur p-6 transition hover:border-[var(--primary)]/30 hover:bg-white/[0.06]"
          >
            <span className="pointer-events-none absolute -inset-10 -z-10 rounded-3xl bg-[var(--primary)]/0 blur-3xl transition group-hover:bg-[var(--primary)]/14" />
            <span className="pointer-events-none absolute inset-0 rounded-3xl ring-1 ring-white/5" />
